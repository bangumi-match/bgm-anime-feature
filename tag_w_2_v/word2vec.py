...
class EnhancedAnimeQuery:
  def __init__(self, model_path, anime_vectors):
    ...
    for aid, ainfo in anime_vectors.items():
      if ainfo is not None and ainfo['vector'] is not None:
...
if __name__ == "__main__":
  # 数据准备
  sentences, animes = prepare_data('anime_lite.json')
